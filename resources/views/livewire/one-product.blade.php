                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="{{ asset('storage/' . $product->images[0]->path) }}"
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        @foreach ($product->images as $image)
                                            <a class="product-gallery-item active" href="#"
                                                ...
                                                <img src="{{ asset('storage/' . $image->path) }}" alt="product side">
                                            </a>
                                        @endforeach
                                ...
                                @if (!isset($product->cartForUser))
                                    <form wire:submit.prevent="addToCart">
                                        ...
                                        <div class="details-filter-row details-row-size">
                                            ...
                                            <div class="product-details-quantity">
                                                <input type="number" id="qty" name="quantity"
                                                    class="form-control" value="0" min="1" max="10"
                                                    step="1" wire:model="quantity">
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-details-action">
                                            <div class="btn-group">
                                                <button type="submit" class="btn-product btn-cart btn-outline-primary">
                                                    add to cart
                                                </button>
                                            </div>
                                        </div>
